...
public class MyAIMessage : IDisposable
{
    ...
    public MyAIMessage(ChatCompletionRole role, string contentStr)
    {
        Role = role;
        ContentStr = contentStr;
    }

    public MyAIMessage(ChatCompletionRole role, StringBuilder contentSb)
    {
        Role = role;
        ContentSb = contentSb;
    }
