...
namespace Nobi.UiRoundedCorners {
	...
	public class ImageWithIndependentRoundedCorners : MonoBehaviour {
		...
		public void Validate() {
			if (material == null) {
				var shaderName = "UI/RoundedCorners/IndependentRoundedCorners";
				var shader = Shader.Find(shaderName);
				if (shader == null) {
					Debug.LogError($"[ImageWithIndependentRoundedCorners] Shader not found: {shaderName}. Please ensure it is included in the build (e.g., added to Always Included Shaders in Graphics Settings).");
				}
