...
static Il2CppObject* FunctionToDelegate(struct pesapi_ffi* apis, pesapi_env env, pesapi_value jsval, JsClassInfoHeader* classInfo)
{
    ...
    if (ret == nullptr || (Object::GetClass(ret) != classInfo->TypeId))
    {
        ...
        case IL2CPP_TYPE_PTR:
        {
            if (apis->is_function(env, jsval))
            {
                if (IsDelegate(klass))
                {
                    ...
                    if (!jsClassInfo || !jsClassInfo->DelegateBridge)
                    {
            ...
            {
                return il2cpp::vm::Class::IsValuetype(objClass) ? Object::Box(objClass, ptr) : (Il2CppObject*)ptr;
            }
            return nullptr;
        }
        case IL2CPP_TYPE_VALUETYPE:
...
{
    return (apis->is_object(env, jsValue)) ?  apis->get_property_uint32(env, jsValue, 0) : nullptr;
}
...
static void JsObjectSetRef(struct pesapi_ffi* apis, pesapi_env env, pesapi_value outer, pesapi_value val)
{
    ...
    {
        apis->set_property_uint32(env, outer, 0, val);
    }
}
...
static void ReflectionGetFieldWrapper(struct pesapi_ffi* apis, pesapi_callback_info info, FieldInfo* field, size_t offset, Il2CppClass* fieldType)
{
    ...
    if (il2cpp::vm::Class::IsValuetype(fieldType))
    {
        ...
        if (!jsVal) 
        {
            if (isFieldPtr)
            {
                jsVal = apis->native_object_to_value(env, expectType, storage, false);
            }
            else
            {
                ...
                jsVal = apis->native_object_to_value(env, expectType, buff, true);
            }
        }
...
Il2CppObject* GetModuleExecutor(struct pesapi_ffi* apis, intptr_t ptr, Il2CppReflectionType* rtype)
{
    ...
    pesapi_value func = apis->get_property(env, global, EXECUTEMODULEGLOBANAME);
    if (!func)
    {
...
static void* OnCsObjectEnter(void* ptr, JsClassInfo* classInfo, JsEnvPrivate* jsEnvPrivate)
{
    if (classInfo->IsValueType)
    {
        ...
        {
            return reinterpret_cast<void*>(jsEnvPrivate->RefCSObject(Object::Box(classInfo->TypeId, ptr)));
        }
        return nullptr;
    }
    else
...
{
    if (!il2cpp::vm::Method::IsGeneric(method) || il2cpp::vm::Method::IsInflated(method))
    {
        return method;
    }
    ...
    for (uint32_t i = 0; i < count; i++)
    {
        ...
        //Il2CppClass* pklass = il2cpp::vm::Class::FromGenericParameter(param);
        //genericArguments[i] = &(il2cpp::vm::Class::GenericParamGetBaseType(pklass)->byval_arg); // debug 下 GenericParamGetBaseType对于IL2CPP_TYPE_MVAR，其is_generic_argument判断很奇怪：type->type == IL2CPP_TYPE_VAR || type->type == IL2CPP_TYPE_VAR，疑似笔误，从2022到6000都一样
        // 拷贝il2cpp::vm::Class::GenericParamGetBaseType过来修改
...
static bool RegisterType(Il2CppClass* klass)
{
    ...
    if (isDelegate)
    {
        ...
        try
        {
            ...
            classInfo->DelegateBridge = FindBridgeFunc(signature.c_str(), il2cpp::vm::Class::IsInflated(klass));
            if (!classInfo->DelegateBridge)
            {
                signature = "";
    ...
    for (auto const& method : methods)
    {
        pesapi_set_method_info(
            properties, pos++, method->Name, method->IsStatic, &MethodCallback, method, nullptr);
    }

    for (auto const& kv : gseters)
    {
        auto geter_or_setter = kv.second.first ? kv.second.first : kv.second.second;
        pesapi_set_property_info(properties, pos++, geter_or_setter->Name, geter_or_setter->IsStatic,
    ...
    {
        pesapi_set_property_info(properties, pos++, field.Data->FieldInfo->name, field.IsStatic,
            GetterCallback, SetterCallback, field.Data, field.Data, nullptr);
    }

    pesapi_define_class(classInfo->TypeId, classInfo->SuperTypeId, classInfo->TypeId->name,
...
void InitialPuerts(pesapi_func_ptr* func_array)
{
    ...
    puerts::s_ParamArrayAttribute = il2cpp::vm::Class::FromName(il2cpp_defaults.corlib, "System", "ParamArrayAttribute");
    puerts::s_ExtensionAttribute = il2cpp::vm::Class::FromName(il2cpp_defaults.corlib, "System.Runtime.CompilerServices", "ExtensionAttribute");
    ...
    puerts::s_UnityEngineObjectOpEqualityMethodInfo = il2cpp::vm::Class::GetMethodFromName(puerts::s_UnityEngineObjectClass, "op_Equality", 2);
